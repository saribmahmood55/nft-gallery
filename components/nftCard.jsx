        ...
        <div className="w-1/4 flex flex-col ">
            ...
            <div className="flex flex-col y-gap-2 px-2 py-3 bg-slate-100 rounded-b-md h-110 ">
                <div className="">
                    ...
                    <button className="text-gray-600" onClick={() => copyToClipboard(nft.contract.address)} >{`${nft.contract.address.substr(0, 4)}...${nft.contract.address.substr(nft.contract.address.length - 4)}`}</button>
                </div>
